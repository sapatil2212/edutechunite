...
import { Calendar, Clock, Edit, Eye, Users, ArrowLeft } from "lucide-react";
...
export default function TeacherExamSchedulePage() {
  ...
  const filteredSchedules = schedules.filter((schedule) => {
    ...
    if (filter === "pending") {
      return schedule.marksEntryStatus === "NOT_STARTED" || schedule.marksEntryStatus === "IN_PROGRESS";
    }
    return true;
  });
            ...
            >
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <span>{new Date(schedule.examDate).toLocaleDateString("en-US", {
                    weekday: "short",
                    year: "numeric",
                    month: "short",
                    day: "numeric"
              ...
              <div className="flex items-center gap-2 pt-4 border-t border-gray-200 dark:border-dark-700">
                <button
                  onClick={() =>
                    router.push(`/teacher/exams/marks-entry?scheduleId=${schedule.id}`)
                  }
                ...
                <button
                  onClick={() =>
                    router.push(`/teacher/exams/results?scheduleId=${schedule.id}`)
                  }
