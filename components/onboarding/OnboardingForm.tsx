...
import { ArrowLeft, ArrowRight, Loader2, CheckCircle2, Eye, EyeOff, AlertCircle } from 'lucide-react'
  ...
  if (successData) {
    return (
      ...
      >
        ...
        >
          <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Your Institution ID</p>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <span className="text-xs text-gray-500 dark:text-gray-500">
            {step === 1 ? 'Institution Type' : 'Details & Account'}
          </span>
        </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Tell us about your institution so we can personalize your experience.
              </p>
            </div>
            ...
            <InstitutionTypeSelector
              ...
              onChange={(type) => {
                updateFormData('institutionType', type)
                if (type !== 'school') {
            ...
            {errors.institutionType && (
              <p className="text-xs text-red-500 mt-1">{errors.institutionType}</p>
            )}

            <SchoolTypeSelect
              value={formData.schoolType}
              onChange={(type) => updateFormData('schoolType', type)}
              visible={formData.institutionType === 'school'}
        ...
        {step === 2 && (
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Complete your profile and create your admin account.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-xs font-medium text-gray-800 dark:text-gray-200">
                <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center">
                  <span className="text-[10px] font-bold text-primary-700 dark:text-primary">1</span>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={`Enter your ${getInstitutionLabel().toLowerCase()} name`}
            ...
            <div className="space-y-3 pt-3 border-t border-gray-100 dark:border-dark-700">
              <div className="flex items-center gap-2 text-xs font-medium text-gray-800 dark:text-gray-200">
                <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center">
                  <span className="text-[10px] font-bold text-primary-700 dark:text-primary">2</span>
                </div>
                Admin / Owner Details
              </div>
            ...
            <div className="space-y-3 pt-3 border-t border-gray-100 dark:border-dark-700">
              <div className="flex items-center gap-2 text-xs font-medium text-gray-800 dark:text-gray-200">
                <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center">
                  <span className="text-[10px] font-bold text-primary-700 dark:text-primary">3</span>
                </div>
                Create Password
              </div>
